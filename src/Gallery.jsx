            ...
            <Container>
                <Row xs={2} sm={4} md={5} lg={6}>
                    ...
                    {props.allbeast.map(data2 => (
                        <HornedBeast index={idx } onClick={props.mostrarModal(data2.title)} key={data2.id} title={data2.title} description={data2.description} horns={data2.horns} keyword={data2.keyword} imageUrl={data2.image_url} />
                    ))
                    }
                </Row>
            </Container>
